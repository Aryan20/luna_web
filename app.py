...
with st.sidebar:
  ...
  st.write("Disclaimer: Results based on such models are not replacement for regular checkup. Please refer to a specialist doctor for proper checkup")
  st.divider()
...
def main():
    ...
    st.divider()
    st.subheader('Made with 💌 by Aryan Kaushik')
